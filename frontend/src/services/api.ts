...
export const authAPI = {
  ...
  register: async (username: string, email: string, password: string, groupCode: string) => {
    const response = await api.post('/auth/register', { username, email, password, groupCode });
    return response.data;
  },
